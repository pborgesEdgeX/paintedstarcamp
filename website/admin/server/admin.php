...
echo $payment;
$week = $_POST['week'];
$waitlisted = $_POST['waitlisted'];


$sql = "UPDATE customers SET parentName='$firstName', lastName='$lastName', email='$email', phone='$phone', studentName='$student_name', week='$week', payment='$payment', waitlisted='$waitlisted' WHERE CustomersID='$id'";
...
<p style="line-height: 1.2; word-break: break-word; text-align: center; font-family: Lora, Georgia, serif; font-size: 46px; mso-line-height-alt: 55px; margin: 0;"><span style="font-size: 46px;"><strong style="color:#3f93d3">Hey '.$firstName. ' , <br> Your deposit has been received. We are very excited to see '.$student_name.' between  '.$week.'<br><br>We are located at: 11590 NEW AVENUE, GILROY, CA</strong></span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 16px; line-height: 1.8; word-break: break-word; font-family: Open Sans, Helvetica Neue, Helvetica, Arial, sans-serif; mso-line-height-alt: 29px; margin: 0;"><span style="font-size: 16px;"><strong>As a reminder, Please make sure '.$student_name.' brings/wears:</strong></span></p>
<ul>
...
// $admin_subject = "Camp Appointment: \n\n";
// $admin_number = "7605740037";
//
// $Text .= "Customer: ";
// $Text .= $parent_name ." ".$last_name;
// $Text .= "\n";
// $Text .= "Email: ";
// $Text .= $email;
// $Text .= "\n";
...
if($payment == 'paid')
    {
      if ($conn->query($sql) === TRUE)
        {
            echo "Record (IF) Updated Successfully";
...
else
    {
          if ($conn->query($sql) === TRUE)
            {
                echo "Record (ELSE) Updated Successfully";
            }
        else
            {
              echo "Error updating record: " . $conn->error;
